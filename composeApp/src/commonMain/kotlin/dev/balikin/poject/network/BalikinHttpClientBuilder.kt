...
class BalikinHttpClientBuilder(
    ...
    fun build(engine: HttpClientEngine): HttpClient {
        return HttpClient(engine) {
            ...
            defaultRequest {
                url {
                    protocol = this@BalikinHttpClientBuilder.protocol
                    host = this@BalikinHttpClientBuilder.host
                    this@BalikinHttpClientBuilder.port?.let { port = it }
                }
