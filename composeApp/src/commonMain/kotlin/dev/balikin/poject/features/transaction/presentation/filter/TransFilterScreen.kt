        ...
        Column(
            ...
            FilterSection(
                ...
                onOptionSelected = { option ->
                    ...
                    onEvent(TransFilterUiEvent.OnSortOrderChanged(newSortOrder))
                }
            )
            HorizontalDivider(modifier = Modifier.padding(bottom = 8.dp))
            Row(
                ...
                if (uiState.startDate != null || uiState.endDate != null) {
                    TextButton(
                        onClick = {
                            onEvent(TransFilterUiEvent.OnStartDateChanged(null))
                            onEvent(TransFilterUiEvent.OnEndDateChanged(null))
                        }
                    ) {
                        Text(
                            text = "Clear",
